...
def main() -> None:
    ...
    parser.add_argument("--experiment-id", default=_parameter("MLFLOW_EXPERIMENT_ID"))
    parser.add_argument("--experiment-name", default=_parameter("MLFLOW_EXPERIMENT_NAME", "/Shared/globalmart-supply-chain-supervisor-evaluation-dev"))
